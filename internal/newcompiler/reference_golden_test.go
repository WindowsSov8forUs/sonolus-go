...
var updateReferenceGolden = flag.Bool("update-reference", false, "update checked-in newcompiler reference golden")
...
func TestReferenceEngineDataGolden(t *testing.T) {
	...
	if !reflect.DeepEqual(actual, expected) {
		t.Fatalf("reference golden differs; run go test ./internal/newcompiler -run TestReferenceEngineDataGolden -update-reference")
	}
}
