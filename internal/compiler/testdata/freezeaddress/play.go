...
type Memory struct{ play.Archetype }

type Once struct{ play.Archetype }
...
type Static struct{ play.Archetype }

type ReadMemory struct{ play.Archetype }

type ReadDirect struct{ play.Archetype }
